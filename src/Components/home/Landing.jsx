...
const Landing = () => {
  ...
  return (
    <div className="overflow-hidden h-screen">
      <div className={`w-full h-full flex justify-center items-center px-2 py-4 transition-all duration-500 ${isHovered ? 'justify-start ml-[-400px]' : ''}`}>
        <div className={`transition-all duration-500`}>
          <h1
            className={`h-[240px] w-[680px] font-light text-black text-[128px] leading-[120px] tracking-[-7px] items-center transition-all duration-500 text-left`}
      ...
      <p className="fixed bottom-4 left-4 w-[316px] h-[72px] text-[14px]">
      ...
      <div className={`fixed left-4 top-1/2 -translate-y-1/2 transition-all duration-500 ${isHovered ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
        <Link>
